...
//  ProgrammingJokes
//
//  Created by Emma Bradford on 2/17/21.
//
...
struct ContentView: View
{
    ...
    var body: some View
    {
        ...
        .alert(isPresented: $showingAlert, content: {
            Alert(title: Text("Loading Error"), message: Text("issue loading data"), dismissButton: .default(Text("OK")))
        })
    }
    
    func getJokes()
    {
       let apiKey = "?rapidapi-key=2ec08bd9e5msh4725dc22b76a14cp1c3cc2jsn264479af3f9b"
